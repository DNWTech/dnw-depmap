...
/**
 * A class for project nature runtime classes. It can configure a project with the project nature,
...
public class Nature implements IProjectNature {
	 ...
	 * method is called, and need not be added here. Exceptions thrown by this method will be
	 * propagated back to the caller of <code>IProject.setDescription</code>, but the nature will
	 ...
	 * method is called, and need not be removed here. Exceptions thrown by this method will be
	 * propagated back to the caller of <code>IProject.setDescription</code>, but the nature will
	 * still be removed from the project description.
	 * 
	 * @author manbaum
	 * @since Sep 30, 2014
	 * @throws CoreException if this method fails.
